    ...
    <div className="min-h-screen bg-black text-white pt-16 font-sans">
      ...
      <div className="relative h-96 w-full flex flex-col items-center justify-center bg-black px-6">
        <div className="relative z-10 text-center">
          ...
          <p className="text-base md:text-lg font-light text-gray-300 mt-2">Your Journey, Our Commitment</p>
        </div>
        <p className="text-base md:text-lg text-gray-300 leading-relaxed text-center max-w-4xl mt-8 font-light">
      ...
      <div className="container mx-auto px-6 py-16 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-0 bg-black shadow-md">
              ...
              <p className="text-base md:text-lg text-gray-300 pb-6 text-left font-light">We build lasting relationships through transparent communication and unwavering integrity. Our clients can depend on us for honest advice and fair dealings.</p>
            </div>
            <div className="p-0 bg-black shadow-md">
              ...
              <p className="text-base md:text-lg text-gray-300 pb-6 text-left font-light">We offer a meticulously curated selection of reliable and exceptional vehicles. Each car is hand-picked and rigorously inspected to meet our high standards.</p>
            </div>
            <div className="p-0 bg-black shadow-md">
              ...
              <p className="text-base md:text-lg text-gray-300 pb-6 text-left font-light">Our dedication to customer satisfaction extends from the moment you browse our selection to long after you drive off the lot. We are here to support you throughout your ownership experience.</p>
            </div>
        </div>
      </div>
      <Footer />
